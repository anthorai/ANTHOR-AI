...
import { aiNewsArticles } from '@/react-app/data/blogArticles';

export default function AINews() {
  useEffect(() => {
    document.title = 'AI News — Stay Ahead of the Future | Anthor AI';
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Latest breakthroughs, innovations, and global updates in artificial intelligence from Anthor AI.');
    }
  }, []);
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center space-x-2 text-sm text-slate-400 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-cyan-400 font-semibold">AI News</span>
          </nav>
          ...
          <div className="relative mb-16 overflow-hidden rounded-3xl"
            style={{
              ...
              boxShadow: '0 8px 32px rgba(0, 240, 255, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.1)'
            }}>
            ...
            <div className="relative px-8 py-16 md:py-24">
              <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-6">
                AI News — Stay Ahead of the Future
              </h1>
              <p className="text-xl md:text-2xl text-slate-300 max-w-3xl">
                Latest breakthroughs, innovations, and global updates in artificial intelligence.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-white">
                {aiNewsArticles.length} Articles
              </h2>
            </div>
