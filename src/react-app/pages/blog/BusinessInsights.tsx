...
import { businessInsightsArticles } from '@/react-app/data/blogArticles';

export default function BusinessInsights() {
  useEffect(() => {
    document.title = 'Business Insights — AI Meets Strategy | Anthor AI';
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Deep dives into AI-driven business transformation, strategy, and automation trends from Anthor AI.');
    }
  }, []);
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center space-x-2 text-sm text-slate-400 mb-8">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-cyan-400 font-semibold">Business Insights</span>
          </nav>
          ...
          <div className="relative mb-16 overflow-hidden rounded-3xl"
            ...
            <div className="relative px-8 py-16 md:py-24">
              <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent mb-6">
                Business Insights — AI Meets Strategy
              </h1>
              <p className="text-xl md:text-2xl text-slate-300 max-w-3xl">
                Deep dives into AI-driven business transformation, strategy, and automation trends.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-white">
                {businessInsightsArticles.length} Articles
              </h2>
            </div>

            <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
              {businessInsightsArticles.map((article) => (
                  ...
                  <div className="bg-slate-900/50 backdrop-blur rounded-xl border border-slate-800 overflow-hidden hover:border-cyan-400/50 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-400/20">
                    <div className="relative overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <span className="px-3 py-1 bg-cyan-600/90 text-white text-sm rounded-full">
                          {article.category}
                        </span>
                      </div>
                    </div>
