          ...
          <div className="flex items-center justify-between h-16 lg:h-18">
            ...
            <div className="flex items-center lg:hidden">
              ...
              <Link to="/" className="flex items-center space-x-2 group" onClick={handleCloseMobileMenu}>
                ...
                <span className="text-lg sm:text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-lg" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  ANTHOR-AI
                </span>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                <div className="relative">
                  ...
                  >
                    <img
                      src={`https://ui-avatars.com/api/?name=${encodeURIComponent(user.user_metadata?.full_name || user.email || 'User')}&background=3b82f6&color=fff`}
